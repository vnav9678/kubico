  ...
  if (state.items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        <h1 className="text-2xl font-bold text-[#374151] mb-4">Your Quote</h1>
        <p className="text-gray-500 mb-6">Your cart is empty. Add some products to generate a quote.</p>
        <Link to="/catalog">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-[#374151]">Your Quote</h1>
      ...
      <div className="hidden print:block mb-8">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500">Modular Garden Planters</p>
            <p className="text-sm text-gray-500">hello@kubico.com</p>
          </div>
          <div className="text-right text-sm text-gray-600">
            <p>Quote Reference: KUB-Q-{Date.now().toString().slice(-8)}</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-[#F8F5F0] border-b border-gray-200">
              <tr>
                <th className="px-4 py-3 text-left font-semibold text-[#374151]">Product</th>
                <th className="px-4 py-3 text-left font-semibold text-[#374151]">Finish</th>
                <th className="px-4 py-3 text-left font-semibold text-[#374151] hidden md:table-cell">Configuration</th>
                <th className="px-4 py-3 text-center font-semibold text-[#374151]">Qty</th>
                <th className="px-4 py-3 text-right font-semibold text-[#374151]">Unit</th>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#F8F5F0] rounded-xl p-5 text-sm text-gray-600">
          <h3 className="font-semibold text-[#374151] mb-2">Notes</h3>
          <ul className="space-y-1 list-disc list-inside text-xs">
            <li>All prices include material and assembly components.</li>
            <li>Delivery is quoted separately (€9.95 standard).</li>
            <li>Lead time: 3–5 business days for standard sizes.</li>
      ...
      <div className="mt-6 no-print flex flex-wrap gap-3 justify-end">
        <Link to="/cart">
          <Button variant="ghost">Edit Cart</Button>
        </Link>
        <Link to="/checkout">
          <Button variant="primary" size="lg">Proceed to Checkout &rarr;</Button>
        </Link>
      </div>
    </div>
  );
